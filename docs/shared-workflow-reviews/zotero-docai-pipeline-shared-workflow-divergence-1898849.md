...
Shared source: `fr-meyer/agent-toolkit` at `1898849ef63e97d2ee4b26eb8ad596c553f1e368`
...
- The consumer file differs from the shared starter template, but no specific high-level contract fact was extracted automatically.
